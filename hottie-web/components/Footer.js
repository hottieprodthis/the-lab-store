  ...
  return (
    <footer className="border-t border-white/10 py-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 px-5 text-center">
        ...
        >
          {/* BOTÓN CIRCULAR BG-VOLT CON ICONO NEGRO */}
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-volt transition duration-200 group-hover:scale-105">
            <svg
              viewBox="0 0 24 24"
              className="h-7 w-7 fill-ink"
              aria-hidden="true"
            >
