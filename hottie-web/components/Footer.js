  ...
  return (
    <footer className="border-t border-white/10 py-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 px-5 text-center">
        ...
        {/* ENLACE SPOTIFY UNIFICADO CON EL DISEÑO DE BOTONES */}
        <a
        ...
        >
          {/* BOTÓN CIRCULAR CON FONDO VERDE Y LOGO NEGRO */}
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-volt text-ink transition duration-200 group-hover:scale-105">
            <svg
              viewBox="0 0 24 24"
              className="h-6 w-6"
              aria-hidden="true"
            >
              {/* ONDAS Y SILUETA EN NEGRO */}
              <path
                fill="#0A0A0D"
