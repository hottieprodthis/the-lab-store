  ...
  return (
    <footer className="border-t border-white/10 py-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 px-5 text-center">
        ...
        {/* ENLACE SPOTIFY CON LOGO ORIGINAL Y BLINDAJE ANTI-INVERSIÓN */}
        <a
        ...
        >
          {/* LOGO VERDE ORIGINAL CON MÁSCARA Y PROTECCIÓN MODO NOCHE */}
          <div
            className="flex items-center justify-center rounded-full bg-volt p-2 transition duration-200 group-hover:scale-105"
            style={{
