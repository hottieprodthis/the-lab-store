  ...
  return (
    <footer className="border-t border-white/10 py-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 px-5 text-center">
        ...
        {/* ENLACE SPOTIFY - LOGO ORIGINAL RESTAURADO */}
        <a
        ...
        >
          {/* LOGO EXACTO DE ANTES CON BLINDAJE DIRECTO */}
          <svg
            viewBox="0 0 24 24"
            className="h-12 w-12 fill-volt text-volt transition duration-200 group-hover:scale-105"
            style={{
